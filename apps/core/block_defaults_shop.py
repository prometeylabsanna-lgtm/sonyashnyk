...
_reg("catalog", "filters_volume", "Обʼєм", label="Група обʼєму", inline=True)
_reg("catalog", "filters_weight", "Вага", label="Група ваги", inline=True)
_reg("catalog", "filters_pieces", "Кількість шт", label="Група кількості", inline=True)
