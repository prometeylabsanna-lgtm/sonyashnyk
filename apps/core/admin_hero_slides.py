...
class HeroSlideForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "eyebrow_ru": CmsAdminTextInputWidget(),
            "title": CmsAdminTextInputWidget(),
            "title_ru": CmsAdminTextInputWidget(),
            "lead": CmsAdminTextareaWidget(attrs={"rows": 3}),
            "lead_ru": CmsAdminTextareaWidget(attrs={"rows": 3}),
            "image": UnfoldAdminFileFieldWidget(),
            "alt_text": CmsAdminTextInputWidget(),
            "alt_text_ru": CmsAdminTextInputWidget(),
            "cta1_text": CmsAdminTextInputWidget(),
            "cta1_text_ru": CmsAdminTextInputWidget(),
            "cta1_url": CmsAdminTextInputWidget(),
            "cta2_text": CmsAdminTextInputWidget(),
            "cta2_text_ru": CmsAdminTextInputWidget(),
            "cta2_url": CmsAdminTextInputWidget(),
            "order": forms.HiddenInput(),
            "is_active": UnfoldBooleanWidget(),
        }
        help_texts = {
            "eyebrow": "Маленький рядок над заголовком. Можна лишити порожнім.",
            "title": "Головний заголовок слайда.",
            "lead": "Підпис під заголовком — одне-два короткі речення.",
            "image": "Фото банера, краще ширше за висоту. Якщо не завантажити — буде стандартне.",
            "alt_text": "Короткий опис фото для тих, хто не бачить зображення.",
            "cta1_text": "Текст першої кнопки — кілька слів.",
            "cta1_url": "Куди веде перша кнопка (наприклад /katalog/).",
            "cta2_text": "Текст другої кнопки — кілька слів. Можна порожнім.",
