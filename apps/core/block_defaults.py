...
_TIMELINE = [
    ("2003", "Перші кроки з землею", "Починаємо шлях у вирощуванні рослин та їх захисті — основа досвіду ТМ «Соняшник».", "img/about/apples.png"),
    ("2012", "Мережа крамниць", "Розвиваємо мережу «Соняшник»: свіжа продукція від перевірених виробників із дотриманням умов зберігання.", "img/about/harvest-bag.png"),
    ("2018", "Бренди світу й України", "Стаємо офіційним представником провідних аграрних брендів. Асортимент — насіння, захист, добрива, інструмент і полив.", "img/about/field-hands.png"),
...
STATIC_FALLBACKS[("about", "produce_image")] = "img/about/produce-cta.png"
